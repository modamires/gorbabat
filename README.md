...
این مقادیر را **داخل کد یا GitHub قرار نده**:
...
فعلاً برای این Repository لایسنس انتخاب نشده است. اگر می‌خواهی دیگران اجازه‌ی مشخصی برای استفاده، تغییر یا انتشار کد داشته باشند، قبل از انتشار عمومی یک License مناسب مثل MIT انتخاب کن.
